  ...
  render() {
    return (
      <div className="container Example">
        ...
        <div className="motto-update example-output example-code code-name">
          {/* Your problem #1 motto displaying and updating widget goes here */}
          <p>Our name is &ldquo; {this.state.name} &rdquo;.</p>
          <p>Our motto is &ldquo; {this.state.motto} &rdquo;</p>
          <input
          type="text"
...
`<p>My name is "{this.state.name}".</p>`
        ...
        <p className="example-output">
          Our name is &ldquo; {this.state.name} &rdquo;.
        </p>
